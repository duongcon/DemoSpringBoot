...
//        try {
//            body = OkHttp.getInstance().getController(API.ADMINS, token);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        return body;
...
//            body = OkHttp.getInstance().getController(url.toString(), token);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        return body;
...
//        okhttp3.Response body = null;
//        try {
//            body = OkHttp.getInstance().postController(API.ADMINS, json, token);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        return body;
...
//            StringBuilder url = new StringBuilder();
//            url.append(API.ADMINS).append("/").append(id);
//            body = OkHttp.getInstance().putController(url.toString(), json, token);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        return body;
